 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.room_upgrades", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.graph_edges", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.chain_types", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "tags.graph_nodes", handler: (event: Internal.TagEventJS<any>) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
